...
class RestReadOnlyTest {
    ...
    @Test
    void layerCreate() {
        String schema = '{"name":"points","projection": "EPSG:4326","geometry": "geom","fields":[{"name":"geom","type":"Point","projection":"EPSG:4326"},{"name":"pid","type":"int"}]}'
    ...
    @Test
    void deleteFeature() {
        mockMvc.perform(delete("/layers/points/feature/points.1"))
                .andExpect(status().is4xxClientError())
    }
